namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalcAverageTicketPriceMethodsWrapper

	/// <exclude/>
	public class UsrCalcAverageTicketPriceMethodsWrapper : ProcessModel
	{

		public UsrCalcAverageTicketPriceMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			var passengersCountColumn = esq.AddColumn("UsrPassengersCount");  // SELECT UsrPassengersCount as UsrPassengersCount, UsrPrice as UsrPrice FROM UsrYachts WHERE ...
